...
class authentication {
    ...
    async findUsers( filter ) {
        try {
            const response = await axios.get(`${BACKEND_API_BASE_URL}/user/find-user?filter=${filter}`, { withCredentials: true });
            return response.data;
        } catch (error) {
            throw error;
        }
    ...
    async findUserById( id ) {
        try {
            const response = await axios.get(`${BACKEND_API_BASE_URL}/user/find-user/${id}`, { withCredentials: true });
            return response.data;
        } catch (error) {
            throw error;
        }
